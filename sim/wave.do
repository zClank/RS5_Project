...
add wave -noupdate -group ARBITER1      -color {Magenta}        /dut/arbiter1/*
add wave -noupdate -group EXECUTE1      -color {Sienna}         /dut/execute1/*
add wave -noupdate -group EXECUTE2      -color {Cyan}           /dut/execute2/*
add wave -noupdate -group EXECUTE3      -color {Magenta}        /dut/execute3/*
